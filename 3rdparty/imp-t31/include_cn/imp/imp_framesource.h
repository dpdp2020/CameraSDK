...
/*
 FRAMESOURCE_CALLBACK*定义framesource通道回调函数
 */
typedef int (*FRAMESOURCE_CHN_CALLBACK)(int chn, IMPFrameInfo *frame);
...
/**
 * @fn int IMP_FrameSource_SetChnCallback(int chnNum, FRAMESOURCE_CHN_CALLBACK callback)
 *
 * 设置framesource回调函数
 *
 * @param[in] chnNum 通道号
 ...
 */
int IMP_FrameSource_SetChnCallback(int chnNum, FRAMESOURCE_CHN_CALLBACK callback);
