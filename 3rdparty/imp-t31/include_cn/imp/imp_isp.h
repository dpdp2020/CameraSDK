...
/**
* @fn int IMP_ISP_EnableAutolearn(int adcNum)
* 低功耗平台，启动起始曝光自学习功能
*
* @param[in] adcNum 光敏ADC通道个数
*
* @retval 0 成功
* @retval 非0 失败，返回错误码
*
* @attention 在使用这个函数之前，IMP_ISP_EnableTuning已被调用。
*/
int IMP_ISP_EnableAutolearn(int adcNum);

/**
* @fn int IMP_ISP_DisableAutolearn(void)
* 低功耗平台，关闭起始曝光自学习功能
*
* @param 无
*
...
* @attention 在使用这个函数之前，IMP_ISP_EnableTuning已被调用。
*/
int IMP_ISP_DisableAutolearn(void);
