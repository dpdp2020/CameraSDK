...
int parse_args(LiveTransmitConfig &cfg, int argc, char** argv)
{
    ...
    cfg.timeout      = atoi(Option<OutString>(params, "0", o_timeout).c_str());
    cfg.timeout_mode = atoi(Option<OutString>(params, "0", o_timeout_mode).c_str());
    cfg.chunk_size   = atoi(Option<OutString>(params, "-1", o_chunk).c_str());
    cfg.bw_report    = atoi(Option<OutString>(params, "0", o_bwreport).c_str());
    cfg.stats_report = atoi(Option<OutString>(params, "0", o_statsrep).c_str());
